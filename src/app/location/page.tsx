...
const Location: React.FC<LocationProps> = ({ address, city, postalCode, country }) => (
    <div className="p-4 mb-4 text-center bg-indigo-950 rounded-lg shadow-xl">
      <h3 className="text-3xl font-black uppercase text-blue-200 border-opacity-50 p-4">Location</h3>
    ...
    <PageTransition>
      ...
      <main aria-label="Visit us">
        <div className="gap-4 py-8 mt-16 sm:flex ">
          <div className="flex-none min-h-screen p-2 sm:w-64 sm:ml-6 bg-indigo-950 rounded-lg ">
            <h1 className="mb-4 text-3xl font-black text-center uppercase text-blue-200 p-2">Hours</h1>
            <p className="font-bold text-center uppercase text-[#8093F1]">Open Every Day Of The Week</p>
            <p className="text-center uppercase text-blue-200 font-semibold mb-4 mt-4">7AM - 3PM</p>
